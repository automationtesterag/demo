...
3. Blocks
4. Identifiers
5. Comments (Single-line comments, Block comments, Expressions, Keywords & Reserved words)

### JavaScript Variables
1. Declaring a variable (var, let)
2. Initializing a variable (var, let)
3. Changing a variable (var, let)
...
8. NaN
9. and a complex data type object.
